...
<tagfile>
  ...
  <compound kind="class">
    ...
    <member kind="function">
      ...
      <anchor>a3a83ed364b26688ebccc5aa4dfca6886</anchor>
      <arglist>(self, client)</arglist>
    </member>
    <member kind="function">
      <type>def</type>
      <name>complete</name>
  ...
  <compound kind="class">
    ...
    <member kind="variable" protection="protected">
      <type>std::unique_ptr&lt; shared_memory::ConditionVariable &gt;</type>
      <name>cond_var_</name>
      <anchorfile>classdynamic__graph_1_1DynamicGraphManager.html</anchorfile>
      <anchor>a02a7f9c293d982347f36b2a74f702c37</anchor>
      <arglist></arglist>
    </member>
    <member kind="variable" protection="protected">
      <type>bool</type>
  ...
  <compound kind="class">
    ...
    <member kind="function">
      <type>def</type>
      <name>initialize_tracer</name>
      <anchorfile>classrobot_1_1Robot.html</anchorfile>
      <anchor>a1d39e4c3dd75c6c7592eeafe6596b773</anchor>
    ...
    <member kind="function">
      <type>def</type>
      <name>add_to_ros</name>
      <anchorfile>classrobot_1_1Robot.html</anchorfile>
      <anchor>ac208f7eafdff6ad891e77402167e9ccc</anchor>
      <arglist>(self, entityName, signalName, topic_name=None, topic_type=None)</arglist>
    </member>
    <member kind="function">
      <type>def</type>
  ...
  <compound kind="class">
    <name>ros_nodes::run_command::RosShell</name>
    <filename>classros__nodes_1_1run__command_1_1RosShell.html</filename>
  </compound>
  <compound kind="class">
  ...
  <compound kind="namespace">
    <name>prologue</name>
    <filename>namespaceprologue.html</filename>
  </compound>
  <compound kind="namespace">
    <name>robot</name>
  ...
  <compound kind="namespace">
    ...
    <namespace>ros::dgcompleter</namespace>
    <namespace>ros::ros</namespace>
  </compound>
  <compound kind="namespace">
    <name>ros::dgcompleter</name>
    <filename>namespaceros_1_1dgcompleter.html</filename>
    <class kind="class">ros::dgcompleter::DGCompleter</class>
  </compound>
  <compound kind="namespace">
    <name>ros::ros</name>
    <filename>namespaceros_1_1ros.html</filename>
    <class kind="class">ros::ros::Ros</class>
  </compound>
  <compound kind="namespace">
    <name>ros_nodes</name>
    <filename>namespaceros__nodes.html</filename>
    <namespace>ros_nodes::robot_pose_publisher</namespace>
    <namespace>ros_nodes::run_command</namespace>
    <namespace>ros_nodes::tf_publisher</namespace>
  </compound>
  <compound kind="namespace">
    <name>ros_nodes::robot_pose_publisher</name>
    <filename>namespaceros__nodes_1_1robot__pose__publisher.html</filename>
  </compound>
  <compound kind="namespace">
    <name>ros_nodes::run_command</name>
    <filename>namespaceros__nodes_1_1run__command.html</filename>
    <class kind="class">ros_nodes::run_command::RosShell</class>
  </compound>
  <compound kind="namespace">
    <name>ros_nodes::tf_publisher</name>
    <filename>namespaceros__nodes_1_1tf__publisher.html</filename>
  </compound>
  <compound kind="page">
