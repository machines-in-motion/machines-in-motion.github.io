...
sys.path.insert(0, os.path.abspath("/workspace/software/workspace/src/catkin/core_robotics/mpi_cmake_modules/python"))
...
# Version control
package_xml = os.path.join("/workspace/software/workspace/src/catkin/core_robotics/mpi_cmake_modules", "package.xml")
...
breathe_projects = {project: "/workspace/software/workspace/devel/.private/mpi_cmake_modules/share/mpi_cmake_modules/docs/sphinx/doxygen/xml"}
